...
update-when: audience, product promise, experience doctrine, or rejected direction changes materially.
agent-guidance: Preserve declared human product intent. Mark inferred doctrine. Do not rewrite product doctrine to match accidental implementation.
---
